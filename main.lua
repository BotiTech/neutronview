...
window:addChild(gui.comboBox(3,2,76,3,0x262626,0xFFFFFF,0x000000,0xFFFF00,"Select a file type"))

window:addChild(gui.button(window.width/2-10,5,20,3,0x00FF00,0xFFFFFF,0x000000,0xFFFF00,"Submit"))
